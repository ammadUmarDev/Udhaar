...
//                                H3(
//                                    textBody:
//                                        "Loan requested on: 8:55 PM - November 20, 2020",
//                                    color: kTextDarkColor),
//                              ],
//                            ),
//                          ),
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      if (userDocs[index].data()["Email"] !=
                        ...
                        UserModel tempObj = UserModel(
                          ...
                          userID: userDocs[index].data()["User_Id"].toString(),
                          createdDate:
                              userDocs[index].data()["Created_Date"].toString(),
                          lastPassChangeDate: userDocs[index]
                              .data()["Last_Pass_Change_Date"]
                              .toString(),
                          friendList:
                              userDocs[index].data()["Friend_List"].split(","),
                        );
                        return Center(
                          child: Card(
                            child: InkWell(
